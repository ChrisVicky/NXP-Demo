...
LV_IMG_DECLARE(_btn_list_pause_alpha_42x42);
LV_IMG_DECLARE(_icn_chart_alpha_15x15);
LV_IMG_DECLARE(_cover_3_alpha_105x105);
LV_IMG_DECLARE(_btn_list_play_alpha_42x42);
LV_IMG_DECLARE(_icn_download_alpha_15x15);
LV_IMG_DECLARE(_cover_1_alpha_105x105);
LV_IMG_DECLARE(_icn_chat_alpha_15x15);
LV_IMG_DECLARE(_btn_rnd_alpha_15x15);
LV_IMG_DECLARE(_cover_2_alpha_105x105);
LV_IMG_DECLARE(_wave_top_alpha_480x29);
LV_IMG_DECLARE(_btn_loop_alpha_15x15);
LV_IMG_DECLARE(_btn_pause_alpha_48x48);
LV_IMG_DECLARE(_icn_heart_alpha_15x15);
LV_IMG_DECLARE(_btn_next_alpha_37x37);
LV_IMG_DECLARE(_wave_bottom_alpha_480x29);
