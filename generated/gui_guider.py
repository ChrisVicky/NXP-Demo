...
# create screen_img_11
screen_img_11 = lv.img(screen)
screen_img_11.set_pos(int(235),int(130))
screen_img_11.set_size(15,15)
screen_img_11.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_11.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1865598701.png','rb') as f:
        screen_img_11_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1865598701.png')
    sys.exit()
...
screen_cont_1.set_pos(int(0),int(11))
screen_cont_1.set_size(480,261)
screen_cont_1.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)

# create screen_label_time_8
screen_label_time_8 = lv.label(screen_cont_1)
screen_label_time_8.set_pos(int(440),int(273))
screen_label_time_8.set_size(35,18)
...
try:
    style_screen_label_time_8_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_time_8_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_time_7
screen_label_time_7 = lv.label(screen_cont_1)
screen_label_time_7.set_pos(int(440),int(237))
screen_label_time_7.set_size(35,18)
...
try:
    style_screen_label_time_7_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_time_7_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_time_6
screen_label_time_6 = lv.label(screen_cont_1)
screen_label_time_6.set_pos(int(440),int(202))
screen_label_time_6.set_size(35,18)
...
try:
    style_screen_label_time_6_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_time_6_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_time_5
screen_label_time_5 = lv.label(screen_cont_1)
screen_label_time_5.set_pos(int(440),int(166))
screen_label_time_5.set_size(35,18)
...
try:
    style_screen_label_time_5_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_time_5_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_time_4
screen_label_time_4 = lv.label(screen_cont_1)
screen_label_time_4.set_pos(int(440),int(131))
screen_label_time_4.set_size(35,18)
...
try:
    style_screen_label_time_4_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_time_4_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_time_3
screen_label_time_3 = lv.label(screen_cont_1)
screen_label_time_3.set_pos(int(440),int(95))
screen_label_time_3.set_size(35,18)
...
try:
    style_screen_label_time_3_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_time_3_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_time_2
screen_label_time_2 = lv.label(screen_cont_1)
screen_label_time_2.set_pos(int(440),int(60))
screen_label_time_2.set_size(35,18)
...
try:
    style_screen_label_time_2_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_time_2_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_time_1
screen_label_time_1 = lv.label(screen_cont_1)
screen_label_time_1.set_pos(int(440),int(24))
screen_label_time_1.set_size(35,18)
...
try:
    style_screen_label_time_1_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_time_1_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_author_8
screen_label_author_8 = lv.label(screen_cont_1)
screen_label_author_8.set_pos(int(54),int(282))
screen_label_author_8.set_size(120,18)
...
try:
    style_screen_label_author_8_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_author_8_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
# create screen_label_author_7
screen_label_author_7 = lv.label(screen_cont_1)
screen_label_author_7.set_pos(int(54),int(247))
screen_label_author_7.set_size(120,18)
...
try:
    style_screen_label_author_7_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_author_7_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
# create screen_label_author_6
screen_label_author_6 = lv.label(screen_cont_1)
screen_label_author_6.set_pos(int(54),int(211))
screen_label_author_6.set_size(120,18)
...
try:
    style_screen_label_author_6_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_author_6_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
# create screen_label_author_5
screen_label_author_5 = lv.label(screen_cont_1)
screen_label_author_5.set_pos(int(54),int(176))
screen_label_author_5.set_size(120,18)
...
try:
    style_screen_label_author_5_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_author_5_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
# create screen_label_author_4
screen_label_author_4 = lv.label(screen_cont_1)
screen_label_author_4.set_pos(int(54),int(140))
screen_label_author_4.set_size(120,18)
...
try:
    style_screen_label_author_4_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_author_4_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
# create screen_label_author_3
screen_label_author_3 = lv.label(screen_cont_1)
screen_label_author_3.set_pos(int(54),int(105))
screen_label_author_3.set_size(120,18)
...
try:
    style_screen_label_author_3_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_author_3_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
# create screen_label_author_2
screen_label_author_2 = lv.label(screen_cont_1)
screen_label_author_2.set_pos(int(54),int(69))
screen_label_author_2.set_size(120,18)
...
try:
    style_screen_label_author_2_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_author_2_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
# create screen_label_music_8
screen_label_music_8 = lv.label(screen_cont_1)
screen_label_music_8.set_pos(int(54),int(267))
screen_label_music_8.set_size(120,18)
...
try:
    style_screen_label_music_8_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_music_8_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
# create screen_label_music_7
screen_label_music_7 = lv.label(screen_cont_1)
screen_label_music_7.set_pos(int(54),int(231))
screen_label_music_7.set_size(120,18)
...
try:
    style_screen_label_music_7_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_music_7_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
# create screen_label_music_6
screen_label_music_6 = lv.label(screen_cont_1)
screen_label_music_6.set_pos(int(54),int(196))
screen_label_music_6.set_size(140,18)
...
try:
    style_screen_label_music_6_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_music_6_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
# create screen_label_music_5
screen_label_music_5 = lv.label(screen_cont_1)
screen_label_music_5.set_pos(int(54),int(160))
screen_label_music_5.set_size(120,18)
...
try:
    style_screen_label_music_5_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_music_5_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
# create screen_label_music_4
screen_label_music_4 = lv.label(screen_cont_1)
screen_label_music_4.set_pos(int(54),int(125))
screen_label_music_4.set_size(120,18)
...
try:
    style_screen_label_music_4_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_music_4_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
# create screen_label_music_3
screen_label_music_3 = lv.label(screen_cont_1)
screen_label_music_3.set_pos(int(54),int(89))
screen_label_music_3.set_size(120,18)
...
try:
    style_screen_label_music_3_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_music_3_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
# create screen_label_music_2
screen_label_music_2 = lv.label(screen_cont_1)
screen_label_music_2.set_pos(int(54),int(54))
screen_label_music_2.set_size(140,18)
...
try:
    style_screen_label_music_2_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_music_2_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
screen_img_8.set_pos(int(0),int(257))
screen_img_8.set_size(42,42)
screen_img_8.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_8.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1412726481.png','rb') as f:
        screen_img_8_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1412726481.png')
    sys.exit()

screen_img_8_img = lv.img_dsc_t({
  'data_size': len(screen_img_8_img_data),
  'header': {'always_zero': 0, 'w': 42, 'h': 42, 'cf': lv.img.CF.TRUE_COLOR_ALPHA},
...
screen_img_7.set_pos(int(0),int(221))
screen_img_7.set_size(42,42)
...
screen_img_6.set_pos(int(0),int(186))
screen_img_6.set_size(42,42)
...
screen_img_5.set_pos(int(0),int(150))
screen_img_5.set_size(42,42)
...
screen_img_4.set_pos(int(0),int(115))
screen_img_4.set_size(42,42)
...
screen_img_3.set_pos(int(0),int(79))
screen_img_3.set_size(42,42)
...
screen_img_2.set_pos(int(0),int(44))
screen_img_2.set_size(42,42)
...
# create screen_label_author_1
screen_label_author_1 = lv.label(screen_cont_1)
screen_label_author_1.set_pos(int(54),int(34))
screen_label_author_1.set_size(120,18)
...
try:
    style_screen_label_author_1_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_author_1_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
# create screen_label_music_1
screen_label_music_1 = lv.label(screen_cont_1)
screen_label_music_1.set_pos(int(54),int(18))
screen_label_music_1.set_size(140,18)
...
try:
    style_screen_label_music_1_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_music_1_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
screen_btn_8.set_pos(int(0),int(260))
screen_btn_8.set_size(474,35)
...
try:
    style_screen_btn_8_main_main_default.set_text_font(lv.font_simsun_12)
except AttributeError:
    try:
        style_screen_btn_8_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
screen_btn_7.set_pos(int(0),int(224))
screen_btn_7.set_size(474,35)
...
try:
    style_screen_btn_7_main_main_default.set_text_font(lv.font_simsun_12)
except AttributeError:
    try:
        style_screen_btn_7_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
screen_btn_6.set_pos(int(0),int(189))
screen_btn_6.set_size(474,35)
...
try:
    style_screen_btn_6_main_main_default.set_text_font(lv.font_simsun_12)
except AttributeError:
    try:
        style_screen_btn_6_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
screen_btn_5.set_pos(int(0),int(153))
screen_btn_5.set_size(474,35)
...
try:
    style_screen_btn_5_main_main_default.set_text_font(lv.font_simsun_12)
except AttributeError:
    try:
        style_screen_btn_5_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
screen_btn_4.set_pos(int(0),int(118))
screen_btn_4.set_size(474,35)
...
try:
    style_screen_btn_4_main_main_default.set_text_font(lv.font_simsun_12)
except AttributeError:
    try:
        style_screen_btn_4_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
screen_btn_3.set_pos(int(0),int(82))
screen_btn_3.set_size(474,35)
...
screen_btn_2.set_pos(int(0),int(47))
screen_btn_2.set_size(474,35)
...
try:
    style_screen_btn_2_main_main_default.set_text_font(lv.font_simsun_12)
except AttributeError:
    try:
...
screen_btn_1.set_pos(int(0),int(11))
screen_btn_1.set_size(474,35)
...
try:
    style_screen_btn_1_main_main_default.set_text_font(lv.font_simsun_12)
except AttributeError:
    try:
...
screen_img_1.set_pos(int(0),int(8))
screen_img_1.set_size(42,42)
screen_img_1.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_1.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp1051922355.png','rb') as f:
        screen_img_1_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp1051922355.png')
    sys.exit()
...
# create screen_player
screen_player = lv.obj(screen)
screen_player.set_pos(int(0),int(0))
screen_player.set_size(480,272)
screen_player.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)

# create screen_img_album
screen_img_album = lv.img(screen_player)
screen_img_album.set_pos(int(187),int(84))
screen_img_album.set_size(105,105)
screen_img_album.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_album.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-2019345398.png','rb') as f:
        screen_img_album_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-2019345398.png')
    sys.exit()
...
# create screen_imgbtn_play
screen_imgbtn_play = lv.imgbtn(screen_player)
screen_imgbtn_play.set_pos(int(216),int(199))
screen_imgbtn_play.set_size(48,48)
screen_imgbtn_play.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp916803294.png','rb') as f:
        screen_imgbtn_play_imgReleased_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp916803294.png')
    sys.exit()
...
screen_imgbtn_play.set_src(lv.imgbtn.STATE.RELEASED, None, screen_imgbtn_play_imgReleased, None)
...
screen_imgbtn_play.set_src(lv.imgbtn.STATE.PRESSED, None, screen_imgbtn_play_imgPressed, None)


try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1143594116.png','rb') as f:
        screen_imgbtn_play_imgCheckedReleased_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1143594116.png')
    sys.exit()
...
screen_imgbtn_play.set_src(lv.imgbtn.STATE.CHECKED_RELEASED, None, screen_imgbtn_play_imgCheckedReleased, None)
...
screen_imgbtn_play.set_src(lv.imgbtn.STATE.CHECKED_PRESSED, None, screen_imgbtn_play_imgCheckedPressed, None)

screen_imgbtn_play.add_flag(lv.obj.FLAG.CHECKABLE)

# create screen_img_9
screen_img_9 = lv.img(screen_player)
screen_img_9.set_pos(int(187),int(84))
screen_img_9.set_size(105,105)
screen_img_9.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_9.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1057731381.png','rb') as f:
        screen_img_9_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1057731381.png')
    sys.exit()
...
# create screen_img_10
screen_img_10 = lv.img(screen_player)
screen_img_10.set_pos(int(187),int(84))
screen_img_10.set_size(105,105)
screen_img_10.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_10.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-96117364.png','rb') as f:
        screen_img_10_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-96117364.png')
    sys.exit()
...
# create screen_img_wave_bottom
screen_img_wave_bottom = lv.img(screen_player)
screen_img_wave_bottom.set_pos(int(0),int(243))
screen_img_wave_bottom.set_size(480,29)
screen_img_wave_bottom.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_wave_bottom.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp820399979.png','rb') as f:
        screen_img_wave_bottom_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp820399979.png')
    sys.exit()

screen_img_wave_bottom_img = lv.img_dsc_t({
  'data_size': len(screen_img_wave_bottom_img_data),
  'header': {'always_zero': 0, 'w': 480, 'h': 29, 'cf': lv.img.CF.TRUE_COLOR_ALPHA},
...
# create screen_img_wave_top
screen_img_wave_top = lv.img(screen_player)
screen_img_wave_top.set_pos(int(0),int(0))
screen_img_wave_top.set_size(480,29)
screen_img_wave_top.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_wave_top.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp675648847.png','rb') as f:
        screen_img_wave_top_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp675648847.png')
    sys.exit()
...
# create screen_img_icn_rnd
screen_img_icn_rnd = lv.img(screen_player)
screen_img_icn_rnd.set_pos(int(42),int(218))
screen_img_icn_rnd.set_size(15,15)
screen_img_icn_rnd.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_icn_rnd.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp503170030.png','rb') as f:
        screen_img_icn_rnd_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp503170030.png')
    sys.exit()
...
# create screen_img_icn_loop
screen_img_icn_loop = lv.img(screen_player)
screen_img_icn_loop.set_pos(int(421),int(218))
screen_img_icn_loop.set_size(15,15)
screen_img_icn_loop.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_icn_loop.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp871125390.png','rb') as f:
        screen_img_icn_loop_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp871125390.png')
    sys.exit()
...
# create screen_img_icn_left
screen_img_icn_left = lv.img(screen_player)
screen_img_icn_left.set_pos(int(122),int(204))
screen_img_icn_left.set_size(37,37)
screen_img_icn_left.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_icn_left.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp1054351517.png','rb') as f:
        screen_img_icn_left_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp1054351517.png')
    sys.exit()

screen_img_icn_left_img = lv.img_dsc_t({
  'data_size': len(screen_img_icn_left_img_data),
  'header': {'always_zero': 0, 'w': 37, 'h': 37, 'cf': lv.img.CF.TRUE_COLOR_ALPHA},
...
# create screen_img_icn_right
screen_img_icn_right = lv.img(screen_player)
screen_img_icn_right.set_pos(int(318),int(204))
screen_img_icn_right.set_size(37,37)
screen_img_icn_right.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_icn_right.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1898395299.png','rb') as f:
        screen_img_icn_right_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-1898395299.png')
    sys.exit()
...
screen_slider_1.set_pos(int(42),int(250))
screen_slider_1.set_size(342,1)
...
# create screen_img_icn_msg
screen_img_icn_msg = lv.img(screen_player)
screen_img_icn_msg.set_pos(int(381),int(41))
screen_img_icn_msg.set_size(15,15)
screen_img_icn_msg.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_icn_msg.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp2014754058.png','rb') as f:
        screen_img_icn_msg_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp2014754058.png')
    sys.exit()
...
# create screen_img_icn_heart
screen_img_icn_heart = lv.img(screen_player)
screen_img_icn_heart.set_pos(int(84),int(41))
screen_img_icn_heart.set_size(15,15)
screen_img_icn_heart.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_icn_heart.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp2103114564.png','rb') as f:
        screen_img_icn_heart_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp2103114564.png')
    sys.exit()
...
# create screen_img_icn_donwload
screen_img_icn_donwload = lv.img(screen_player)
screen_img_icn_donwload.set_pos(int(282),int(41))
screen_img_icn_donwload.set_size(15,15)
screen_img_icn_donwload.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_icn_donwload.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp1185074490.png','rb') as f:
        screen_img_icn_donwload_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp1185074490.png')
    sys.exit()
...
# create screen_img_icn_chart
screen_img_icn_chart = lv.img(screen_player)
screen_img_icn_chart.set_pos(int(183),int(41))
screen_img_icn_chart.set_size(15,15)
screen_img_icn_chart.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
screen_img_icn_chart.add_flag(lv.obj.FLAG.CLICKABLE)
try:
    with open('/home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-2126603556.png','rb') as f:
        screen_img_icn_chart_img_data = f.read()
except:
    print('Could not open /home/christopher/Coding/NXP/MusicPlayer1/generated/mPythonImages/mp-2126603556.png')
    sys.exit()
...
# create screen_label_slider_time
screen_label_slider_time = lv.label(screen_player)
screen_label_slider_time.set_pos(int(420),int(245))
screen_label_slider_time.set_size(36,11)
...
try:
    style_screen_label_slider_time_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_slider_time_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_tracks
screen_label_tracks = lv.label(screen_player)
screen_label_tracks.set_pos(int(234),int(270))
screen_label_tracks.set_size(12,1)
...
try:
    style_screen_label_tracks_main_main_default.set_text_font(lv.font_arial_12)
except AttributeError:
    try:
        style_screen_label_tracks_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_btn_tracks
screen_btn_tracks = lv.btn(screen_player)
screen_btn_tracks.set_pos(int(210),int(256))
screen_btn_tracks.set_size(60,16)
...
try:
    style_screen_btn_tracks_main_main_default.set_text_font(lv.font_simsun_12)
except AttributeError:
    try:
        style_screen_btn_tracks_main_main_default.set_text_font(lv.font_montserrat_12)
    except AttributeError:
...
# create screen_label_title_music
screen_label_title_music = lv.label(screen_player)
screen_label_title_music.set_pos(int(150),int(5))
screen_label_title_music.set_size(180,18)
...
try:
    style_screen_label_title_music_main_main_default.set_text_font(lv.font_arial_14)
except AttributeError:
    try:
        style_screen_label_title_music_main_main_default.set_text_font(lv.font_montserrat_14)
    except AttributeError:
...
# create screen_label_title_author
screen_label_title_author = lv.label(screen_player)
screen_label_title_author.set_pos(int(150),int(22))
screen_label_title_author.set_size(180,18)
...
try:
    style_screen_label_title_author_main_main_default.set_text_font(lv.font_arial_10)
except AttributeError:
    try:
        style_screen_label_title_author_main_main_default.set_text_font(lv.font_montserrat_10)
    except AttributeError:
...
def screen_btn_tracks_clicked_1_event_cb(e,screen_player):
    src = e.get_target()
    code = e.get_code()
screen_btn_tracks.add_event_cb(lambda e: screen_btn_tracks_clicked_1_event_cb(e,screen_player), lv.EVENT.CLICKED, None)
